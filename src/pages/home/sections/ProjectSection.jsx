...
const ProjectSection = () => (
  <section>
    <div className="flex flex-col justify-center align-center p-10 bg-[#FBFFDC]">
      ...
      <div className="grid grid-cols-1 grid-rows-6 grid-flow-col gap-8 lg:grid-cols-3 lg:grid-rows-1 lg:grid-flow-row">
        <ShadowCard
          icons={[
            <SiApachekafka />,
            <DiJava />,
          ...
          description={
            <p>
              ...
              Interface. Highly customizable and modular design for addition of
              new actions in less than hour.
              <ol className="desc_style pt-2">
                <li>
                  <strong>Tech:</strong> Java, SpringBoot, Apache Kafka, Netflix
                  Conductor, K8s, Docker, Gradle, Microservices
                </li>
              </ol>
            </p>
          }
        ...
        <ShadowCard
          ...
          description={
            <p>
              Designed and developed a webhook ingestion pipeline to process and
              store webhooks in Postgresql using kafka as buffer and kafka
              consumer for batching and chaining multiple queries to reduce load
              on database.
              <ol className="desc_style pt-2">
                <li>
        ...
        <ShadowCard
          ...
          description={
            <p>
              Configured and Setup entire CDC pipeline components for capturing
              changes in data from multiple sources into kafka. This pipeline
              now powers use cases like table auditing, cumulative dashboard and
              reports, etc...
              <ol className="desc_style pt-2">
                <li>
        ...
        <ShadowCard
          ...
          description={
            <p>
              Redesigned and optimised entire service data flow for performance
              improvement gains in API calls of upto 10x times.
              <ol className="desc_style pt-2">
                <li>
      ...
      <button className="shadowbox m-10 w-fit px-10 py-2 self-center">
        Explore More <MdKeyboardDoubleArrowRight className="inline" />
      </button>
    </div>
  </section>
);
